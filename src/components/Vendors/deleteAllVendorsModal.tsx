...
function DeleteAllVendorsModal({ isOpen, onOpenChange, onClose }: CustomModalProps): JSX.Element {
  return (
        ...
        <ModalBody>
          <div className="flex flex-col py-6">
            ...
            <div className="pt-4 text-center">
              <h3 className="text-lg font-medium">Delete all vendor product</h3>
              <p className="text-sm text-gray-600 dark:text-white mt-1">
                This action cannot be undone. Are you sure you want to delete all of this vendor
                product?
              </p>
            </div>
...
export default DeleteAllVendorsModal;
